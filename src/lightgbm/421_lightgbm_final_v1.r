...
PARAM$finalmodel$learning_rate <- 0.153623867424975
PARAM$finalmodel$feature_fraction <- 0.865527423890872
PARAM$finalmodel$min_data_in_leaf <- 977
PARAM$finalmodel$num_leaves <- 3297
